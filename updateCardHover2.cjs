...
.hero-highlight-card:hover { background: rgba(20, 10, 30, 0.6); transform: translateX(6px); border-color: rgba(176, 38, 255, 0.3); box-shadow: inset 0 1px 1px rgba(176, 38, 255, 0.2), 0 8px 20px rgba(176, 38, 255, 0.15); }`;

const heroNew = `.hero-highlight-card { background: rgba(0, 0, 0, 0.3); border: 1px solid transparent; box-shadow: inset 0 2px 6px rgba(0, 0, 0, 0.4); padding: 12px 16px; border-radius: 14px; display: flex; align-items: center; gap: 14px; transition: transform 300ms ease, background 300ms ease, border-color 300ms ease, box-shadow 300ms ease; font-size: 0.95rem; }
.hero-highlight-card:hover { background: rgba(20, 10, 30, 0.6); transform: translateX(6px); border-color: transparent; box-shadow: inset 0 1px 1px rgba(176, 38, 255, 0.2), 0 8px 20px rgba(176, 38, 255, 0.15); }`;

css = css.replace(heroOld, heroNew);

fs.writeFileSync(cssPath, css, 'utf8');
console.log('Successfully updated hover effects.');
